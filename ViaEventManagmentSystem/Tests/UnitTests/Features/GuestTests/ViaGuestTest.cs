...
public abstract class ViaGuestTest
{
    ...
    public class F3
    {
        ...
        public void GivenInvalidFirstName_InvalidFormatFailure()
        {
            ...
            Assert.Equal(ErrorMessage.PersonName.FirstNameMustBeBetween2And25CharsOrIsNullOrWhiteSpace.ToString(),
                firstName.Error.Messages[0].ToString());
        }
    }
    ...
    public class F4
    {
        ...
        public void GivenInvalidLastName_InvalidFormatFailure()
        {
            ...
            Assert.Equal(ErrorMessage.PersonName.LastNameMustBeBetween2And25CharsOrIsNullOrWhiteSpace.ToString(),
                lastname.Error.Messages[0].ToString());
        }
    }
