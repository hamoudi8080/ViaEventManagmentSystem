...
public abstract class GuestAcceptInvitationTest
{
    ...
    public class F1
    {
        ...
        public void GivenAnExistingEvent_NoInvitationForGuest()
        {
            ...
            Assert.Equal(ErrorMessage.Invitations.GuestNotInvitedToEvent.ToString(),
    ...
    public class F2
    {
        [Fact]
        public void
            GivenAnExistingEventWithIDAndGuestIDAndPendingInvitationAndMaxParticipantsReached_GuestAcceptsInvitation_ShouldRejectParticipant()
        {
            // Arrange
    ...
    public class F3
    {
        [Fact]
        public void
            GivenAnExistingEventWithIDAndGuestIDAndPendingInvitationAndEventStatusCancelled_GuestAcceptsInvitation_ShouldRejectParticipant()
        {
            // Arrange
            var activeEvent = ViaEventTestFactory.CreateActiveEvent();
            var guest = GuestFactory.CreateGuest();
