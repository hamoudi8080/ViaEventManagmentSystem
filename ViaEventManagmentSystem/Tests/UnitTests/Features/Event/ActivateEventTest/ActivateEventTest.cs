...
public abstract class ActivateEventTest
{
    public class S1
    {
        ...
        public void ActivateEvent_WhenEventInDraftStatus_ShouldMakeEventReadyAndSetActive()
        {
            ...
            var myEvent = ViaEvent.Create(id, title, description, startDate, endDate, maxNumberOfGuests,
                eventVisibility,
                eventStatus).Payload;
    ...
    public class F1
    {
        ...
        public void ActivateEvent_WhenEventInDraftStatusSomeFieldsAreMissingInfo()
        {
            ...
            var viaevent = ViaEvent.Create(id, title, description, startDate, endDate, maxNumberOfGuests,
                eventVisibility,
                eventStatus).Payload;
            ...
            Assert.Contains(activationResult.ErrorCollection!, error =>
                error.Messages.Any(message =>
                    message.DisplayName == ErrorMessage.Capacity.MaxGuestsOutOfRange.DisplayName));
        }
    }
