...
public abstract class ReadiesEventTest
{
    ...
    public class F1
    {
        ...
        public void GivenDraftEvent_WithMissingOrInvalidData_WhenMakeEventReady_ThenFailureMessageIsProvided()
        {
            ...
            var viaEvent = ViaEvent.Create(id, title.Payload, description.Payload, null, null,
                maxNumberOfGuests.Payload, null,
                eventStatus).Payload;
    ...
    public class F2
    {
        ...
        public void GivenCancelledEvent_WhenMakeEventReady_ThenFailureMessageIsProvided()
        {
            ...
            Assert.Contains(result.ErrorCollection!, error =>
                error.Messages.Any(message =>
                    message.DisplayName == ErrorMessage.CancelledEventCannotBeMadeReady.DisplayName));
        }
    }
    ...
    public class F3
    {
        ...
        public void GivenEventWithPastStartDateTime_WhenMakeEventReady_ThenFailureMessageIsProvided()
        {
            ...
            var viaEvent = ViaEvent.Create(id, title.Payload, description.Payload, startDate.Payload, endDate.Payload,
                maxNumberOfGuests.Payload, null,
                eventStatus).Payload;
            ...
            Assert.Contains(result.ErrorCollection!, error =>
                error.Messages.Any(message =>
                    message.DisplayName == ErrorMessage.EventInThePastCannotBeReady.DisplayName));
        }
    }
    ...
    public class F4
    {
        ...
        public void GivenEventWithDefaultTitle_WhenMakeEventReady_ThenFailureMessageIsProvided()
        {
            ...
            Assert.Contains(result.ErrorCollection!, error =>
                error.Messages.Any(message =>
                    message.DisplayName == ErrorMessage.TitleMustbeChangedFromDefault.DisplayName));
        }
    }
}