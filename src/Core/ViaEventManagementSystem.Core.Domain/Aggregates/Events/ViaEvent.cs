...
public class ViaEvent : Aggregate<EventId>
{
    ...
    {
        ViaEvent viaEvent = new ViaEvent(eventId, title, description, startDateTime, endDateTime, maxNumberOfGuests, eventVisibility, eventStatus);
    ...
    public Result<ViaEvent> SetMaxNumberOfGuests(MaxNumberOfGuests maxGuests)
    {
        ...
        if (_EventStatus == EventStatus.Cancelled)
        {
            return Result<ViaEvent>.Failure(Error.BadRequest(ErrorMessage.EventLifecycle.CancelledEventCannotBeModified));
        }
    ...
    public Result<ViaEvent> MakeEventReady()
    {
        ...
        {
            errors.Add(Error.BadRequest(ErrorMessage.EventFields.EventVisibilityIsNotSet));
        }
    ...
    public Result<ViaEvent> CancelEvent()
    {
        if (_EventStatus == EventStatus.Cancelled)
        {
            return Result<ViaEvent>.Failure(Error.BadRequest(ErrorMessage.EventLifecycle.CancelledEventCannotBeCancelled));
        }
    ...
    public Result<ViaEvent> ActivateEvent()
    {
        if (_EventStatus == EventStatus.Cancelled)
        {
            return Result<ViaEvent>.Failure(Error.BadRequest(ErrorMessage.EventLifecycle.CancelledEventCannotBeActivated));
        }
    ...
    public Result<Invitation> InviteGuest(GuestId guestId)
    {
        ...
        {
            return Result<Invitation>.Failure(Error.BadRequest(ErrorMessage.Invitations.OnlyActiveOrReadyEventCanBeInvited));
        }
    ...
    public Result AcceptGuestInvitation(GuestId guestId)
    {
        ...
        if (_EventStatus == EventStatus.Cancelled)
        {
            return Result<Invitation>.Failure(Error.BadRequest(ErrorMessage.Participation.CancelledEventCannotBeJoined));
        }
    ...
    public Result RejectGuestInvitation(GuestId guestId)
    {
        ...
        if (_EventStatus == EventStatus.Cancelled)
        {
            return Result<Invitation>.Failure(Error.BadRequest(ErrorMessage.Participation.CancelledEventCannotBeDeclined));
        }
